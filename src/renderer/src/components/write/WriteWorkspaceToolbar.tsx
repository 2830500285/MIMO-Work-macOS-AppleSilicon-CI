        ...
        <div className="write-workspace-toolbar-grid grid w-full min-w-0 items-center gap-2 px-3 py-2 sm:px-4 md:pl-5 md:pr-2 lg:gap-4">
          ...
          >
            ...
            {modeMenuOpen ? (
              <div
                role="menu"
                className="absolute left-0 top-full z-30 mt-2 min-w-[188px] overflow-hidden rounded-2xl border border-ds-border bg-white p-1.5 shadow-[0_18px_40px_rgba(31,35,41,0.12)] dark:border-white/10 dark:bg-ds-card"
              >
          ...
          <div className="write-workspace-toolbar-actions flex min-w-0 items-center justify-end gap-1.5">
            ...
            <span className={`ml-1 inline-flex min-w-[64px] justify-center rounded-lg px-2.5 py-1 text-[11.5px] font-semibold ${
              readOnly
                ...
                : saveStatus === 'dirty'
                  ...
                  : saveStatus === 'saving'
                    ? 'bg-[rgba(251,129,71,0.12)] text-[var(--ds-mimo-orange)] dark:bg-[rgba(251,129,71,0.16)] dark:text-[#ffad7f]'
            ...
            <div ref={exportMenuRef} className="relative">
              ...
              {exportMenuOpen ? (
                <div
                  role="menu"
                  className="absolute right-0 top-full z-30 mt-2 w-52 max-w-[calc(100vw-2rem)] overflow-hidden rounded-2xl border border-ds-border bg-ds-card/95 p-1.5 shadow-[0_22px_48px_rgba(31,35,41,0.16)] backdrop-blur-xl"
                >
                  <button
                    type="button"
                    role="menuitem"
