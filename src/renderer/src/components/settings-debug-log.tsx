...
export function WriteDebugLogModal({
  ...
  return (
    <div className="ds-no-drag fixed inset-0 z-[100] flex items-center justify-center bg-[rgba(31,35,41,0.28)] p-4 backdrop-blur-sm">
      <div className="flex h-[min(86vh,820px)] w-[min(1180px,96vw)] min-w-0 flex-col overflow-hidden rounded-2xl border border-ds-border bg-ds-card shadow-[0_26px_80px_rgba(31,35,41,0.18)]">
