  ...
  override render(): ReactNode {
    ...
    return (
      <div className="flex h-full min-h-0 flex-col items-center justify-center bg-ds-main px-6">
        <div className="w-full max-w-md rounded-2xl border border-amber-200/80 bg-amber-50/90 p-6 text-center shadow-[0_14px_32px_rgba(31,35,41,0.08)] dark:border-amber-800/60 dark:bg-amber-950/35">
