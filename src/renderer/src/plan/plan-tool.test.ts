  ...
  it('extracts plan metadata from a successful create_plan tool result', () => {
    const block = toolBlock({
      meta: {
        ...
        plan: {
          plan_id: '/tmp/ws:.mimo-work/plan/login.md',
          workspace_root: '/tmp/ws',
    ...
    expect(meta).toEqual({
      planId: '/tmp/ws:.mimo-work/plan/login.md',
      workspaceRoot: '/tmp/ws',
      relativePath: '.mimo-work/plan/login.md',
      absolutePath: '/tmp/ws/.mimo-work/plan/login.md',
      operation: 'draft',
